...
const SECTION_TRANSLATION_KEYS: Record<string, string> = {
  profile: 'profileScreen.settings.editProfile',
  friends: 'profileScreen.settings.friends',
  notifications: 'profileScreen.settings.notifications',
  security: 'profileScreen.settings.security',
  language: 'profileScreen.settings.language',
  help: 'profileScreen.settings.help',
};
  ...
  return (
    <ScreenContainer scroll>
      ...
      <Text variant="body" color="secondary">
        {t('profileScreen.settings.placeholder')}
      </Text>
    </ScreenContainer>
  );
};
